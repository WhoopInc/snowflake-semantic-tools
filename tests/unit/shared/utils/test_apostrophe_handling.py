...
class TestApostropheSanitization:
    ...
    def test_synonym_generator_removes_apostrophes(self):
        ...
        synonyms_with_apostrophes = ["user's data", "member's profile", "customer's info", "someone's records"]
        ...
        assert clean_synonyms == ["users data", "members profile", "customers info", "someones records"]
...
class TestApostropheValidation:
    ...
    def test_validates_table_synonyms_with_apostrophes(self):
        ...
        validator._check_table_synonym_content(table_with_bad_synonym, "USER_PROFILES", result)
...
class TestRealWorldExamples:
    ...
    def test_users_activity_synonym(self):
        ...
        synonyms = ["user's activity", "member's workout", "athlete's training"]

        cleaned = [s.replace("'", "").replace("'", "").replace("'", "") for s in synonyms]

        assert cleaned == ["users activity", "members workout", "athletes training"]
