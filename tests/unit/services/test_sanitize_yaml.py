...
class TestYAMLSanitizationService:
    ...
    def test_sanitize_model_table_description(self):
        ...
        model = {
            'name': 'customers',
            'description': "Customer data with {{variable}}"  # Jinja breaking
        }
    ...
    def test_sanitize_model_table_synonyms(self):
        ...
        model = {
            ...
            'meta': {
                'sst': {
                    'synonyms': ["customer's data", "user's info", "clean data"]
                }
            }
        }
    ...
    def test_sanitize_model_column_description(self):
        ...
        model = {
            ...
            'columns': [
                {
                    'name': 'user_id',
                    'description': "Unique ID with {{jinja}}"  # Jinja breaking
                }
            ]
        }
            ...
            'columns': [
                {
                    ...
                    'meta': {
                        'sst': {
                            'synonyms': ["user's ID", "customer's code"]
                        }
                    }
                }
            ]
            ...
            'columns': [
                {
                    ...
                    'meta': {
                        'sst': {
                            'sample_values': ["John's data", "Mary's info", "clean value"]
                        }
                    }
                }
            ]
    ...
    def test_sanitize_model_all_fields(self):
        ...
        model = {
            ...
            'meta': {
                'sst': {
                    'synonyms': ["user's table"]  # Apostrophe removed
                }
            },
            'columns': [
                {
    ...
    def test_sanitize_model_no_changes_needed(self):
        ...
        model = {
            ...
            'meta': {
                'sst': {
                    'synonyms': ["customer table", "user info"]
                }
            }
        }
    ...
    def test_sanitize_preserves_structure(self):
        ...
        model = {
            ...
            'meta': {
                'sst': {
                    'primary_key': ['id'],
                    'synonyms': ["test's table"]  # Has apostrophe
                }
            }
        }
            ...
            'columns': [
                {
                    ...
                    'meta': {
                        'sst': {
                            'sample_values': [None, '', "valid's value"]
                        }
                    }
                }
            ]
