...
from snowflake_semantic_tools.core.models.validation import ValidationResult, ValidationError
from snowflake_semantic_tools.core.models.semantic_model import SemanticMetadataCollection, Metric, Relationship, Filter
...
class TestComponentIntegration:
    ...
    def test_dbt_model_with_semantic_model_integration(self):
        ...
        metric = Metric(
            name="revenue",
            expression="SUM(orders.amount)",
            tables=["orders"]  # References the dbt model
        )
    ...
    def test_semantic_model_component_relationships(self):
        ...
        model = SemanticMetadataCollection(
            metrics=[base_metric, composed_metric],
...
class TestRealWorldIntegrationScenarios:
    ...
    def test_validation_workflow_integration(self):
        ...
        result.add_info(
            "Metric 'user_count' is well-defined",
            file_path="metrics.yml",
            context={"metric": "user_count"}
        )
