...
class TestMetricValidation:
    ...
    def test_metric_missing_name_error(self, validator):
        ...
        semantic_data = {"metrics": {"items": [{"expr": "SUM(amount)", "tables": ["orders"]}]}}
    ...
    def test_metric_missing_expr_error(self, validator):
        ...
        semantic_data = {"metrics": {"items": [{"name": "total_revenue", "tables": ["orders"]}]}}
    ...
    def test_metric_missing_tables_error(self, validator):
        ...
        semantic_data = {"metrics": {"items": [{"name": "total_revenue", "expr": "SUM(amount)"}]}}
    ...
    def test_metric_tables_not_list_error(self, validator):
        ...
        semantic_data = {
            "metrics": {
                "items": [{"name": "total_revenue", "expr": "SUM(amount)", "tables": "orders"}]  # Should be list
            }
        }
    ...
    def test_metric_empty_tables_error(self, validator):
        ...
        semantic_data = {"metrics": {"items": [{"name": "total_revenue", "expr": "SUM(amount)", "tables": []}]}}
    ...
    def test_metric_expr_not_string_error(self, validator):
        ...
        semantic_data = {
            "metrics": {"items": [{"name": "total_revenue", "expr": 123, "tables": ["orders"]}]}  # Should be string
        }
    ...
    def test_metric_empty_expr_error(self, validator):
        ...
        semantic_data = {
            "metrics": {"items": [{"name": "total_revenue", "expr": "   ", "tables": ["orders"]}]}  # Empty/whitespace
        }
    ...
    def test_metric_missing_description_warning(self, validator):
        ...
        semantic_data = {"metrics": {"items": [{"name": "total_revenue", "expr": "SUM(amount)", "tables": ["orders"]}]}}
                ...
                "items": [
                    {
                        ...
                        "left_table": "orders",
                        "right_table": "customers",
                        "relationship_conditions": [123],  # Should be a string, not an integer
                    }
                ]
            }
        }
...
class TestFilterValidation:
    ...
    def test_filter_missing_name_error(self, validator):
        ...
        semantic_data = {"filters": {"items": [{"expr": "status = 'active'"}]}}
    ...
    def test_filter_missing_expr_error(self, validator):
        ...
        semantic_data = {"filters": {"items": [{"name": "active_users"}]}}
...
class TestSemanticViewValidation:
    ...
    def test_semantic_view_empty_tables_error(self, validator):
        ...
        semantic_data = {"semantic_views": {"items": [{"name": "orders_view", "tables": []}]}}
...
class TestIdentifierLengthValidation:
    ...
    def test_metric_long_name_integration(self, validator):
        ...
        semantic_data = {
            "metrics": {
                "items": [
                    {"name": long_name, "description": "Test metric", "expr": "SUM(amount)", "tables": ["orders"]}
                ]
            }
        }
        result = validator.validate(semantic_data)
...
class TestExtractMetricReferences:
    ...
    def test_multiple_references(self, validator):
        ...
        result = validator._extract_metric_references("{{ metric('metric_a') }} + {{ metric('metric_b') }}")
