...
def sample_manifest():
    ...
    return {
        "metadata": {"dbt_version": "1.7.0", "target_name": "prod", "project_name": "analytics_dbt"},
        "nodes": {
...
class TestManifestParser:
    ...
    def test_validate_against_yaml_matches(self, manifest_file):
        ...
        result = parser.validate_against_yaml("memberships_members", "ANALYTICS", "MEMBERSHIPS")
    ...
    def test_validate_against_yaml_database_mismatch(self, manifest_file):
        ...
        result = parser.validate_against_yaml("memberships_members", "WRONG_DATABASE", "MEMBERSHIPS")
    ...
    def test_validate_against_yaml_schema_mismatch(self, manifest_file):
        ...
        result = parser.validate_against_yaml("memberships_members", "ANALYTICS", "WRONG_SCHEMA")
    ...
    def test_validate_against_yaml_model_not_found(self, manifest_file):
        ...
        result = parser.validate_against_yaml("nonexistent_model", "ANALYTICS", "MEMBERSHIPS")
