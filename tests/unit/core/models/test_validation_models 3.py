...
from snowflake_semantic_tools.core.models.validation import (
    ValidationSeverity, ValidationIssue, ValidationError, ValidationWarning,
    ValidationInfo, ValidationSuccess, ValidationResult
)
...
class TestValidationSeverity:
    ...
    def test_severity_ordering(self):
        ...
        severities = [ValidationSeverity.ERROR, ValidationSeverity.WARNING, 
                     ValidationSeverity.INFO, ValidationSeverity.SUCCESS]
...
class TestValidationIssue:
    ...
    def test_validation_warning_creation(self):
        ...
        warning = ValidationWarning(
            message="Hardcoded table reference found",
            file_path="metrics/revenue.yml"
        )
    ...
    def test_validation_info_creation(self):
        ...
        info = ValidationInfo(
            message="Metric could be optimized",
            file_path="metrics/revenue.yml"
        )
