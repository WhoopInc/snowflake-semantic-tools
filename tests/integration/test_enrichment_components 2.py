...
class TestComponentDetermination:
    ...
    def test_no_flags_default_behavior(self):
        ...
        components = _determine_components(
            enrich_all=False, synonyms=False,
            column_types=False, data_types=False, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
    ...
    def test_all_flag_includes_everything(self):
        ...
        components = _determine_components(
            enrich_all=True, synonyms=False,
            column_types=False, data_types=False, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
    ...
    def test_synonyms_flag_shorthand(self):
        ...
        components = _determine_components(
            enrich_all=False, synonyms=True,
            column_types=False, data_types=False, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
    ...
    def test_individual_flags_explicit_control(self):
        ...
        components = _determine_components(
            enrich_all=False, synonyms=False,
            column_types=True, data_types=True, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=True, column_synonyms=False
        )
    ...
    def test_column_synonyms_only(self):
        ...
        components = _determine_components(
            ...
            column_types=False, data_types=False, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=True
        )
    ...
    def test_all_plus_explicit_flags(self):
        ...
        components = _determine_components(
            enrich_all=True, synonyms=False,
            column_types=True, data_types=False, sample_values=False,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
    ...
    def test_sample_values_with_synonyms(self):
        ...
        components = _determine_components(
            enrich_all=False, synonyms=True,
            column_types=False, data_types=False, sample_values=True,
            detect_enums=False, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
...
class TestEnrichmentComponentScenarios:
    ...
    def test_scenario_refresh_data_only(self):
        ...
        components = _determine_components(
            enrich_all=False, synonyms=False,
            column_types=False, data_types=False, sample_values=True,
            detect_enums=True, primary_keys=False,
            table_synonyms=False, column_synonyms=False
        )
